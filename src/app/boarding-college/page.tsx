    ...
    <div>
      ...
      <div className="relative w-full h-84 md:h-108 xl:h-188 font-body!">
        ...
        <div className="absolute top-6 md:top-22 w-fit mx-auto left-0 right-0 flex flex-col justify-center items-center text-white">
          ...
          <p className="text-lg max-w-xl pt-6 md:text-xl font-body text-white text-center">
            At The Threshold Schools, we&apos;ve built more than just
            classrooms—we&apos;ve created a vibrant, nurturing environment where
...
export default BoardingCollege;
