...
const Prompt = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full bg-[#030096] text-white z-50"> 
      ...
      <div className="py-6 px-6 xl:px-0 flex flex-col md:flex-row items-start md:items-center justify-between xl:max-w-screen-xl mx-auto">
        <h1 className="text-3xl pb-8 md:pb-0 lg:text-3xl font-body">Primary School Admissions Now Open!</h1>
