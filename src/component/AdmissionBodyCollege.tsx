...
const AdmissionBodyCollege = () => {
  return (
    <div className="w-full">
      {/* Hero intro */}
      <div className="flex flex-col items-center justify-center bg-[#2F1A6C] py-10 md:py-12 lg:py-20">
...
export default AdmissionBodyCollege;
